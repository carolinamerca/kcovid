...
Nota:  Houve um lapso na base de dados e os óbitos acumulados por idade e por sexo para dia 5/10 estão a 0's. Subituímos esses 0's
...
testes_diarios_grafico_interativo <- ggplotly(testes_diarios_grafico) %>% 
...
#Testagem com média rolante
##Fazer a média rolante
testes_media_rolante <- cbind(covid19pt_testes[,1], rollmean(covid19pt_testes[,3], k = 7, fill = NA))
...
casos_regioes_grafico_interativo <- ggplotly(casos_regioes_grafico) %>% 
    layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Número de Casos",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
#Tornar interativo
incidencia_regioes_tempo_grafico_interativo <- ggplotly(incidencia_regioes_tempo_grafico) %>% 
    layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Incidência",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
prevalencia_regiao_grafico_interativo <- ggplotly(prevalencia_regiao_grafico)%>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Taxa de Incidência Cumulativa",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
ggplotly(casos_fem_masc_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Número de Casos",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
casos_total_tempo_media_rolante <- cbind(casos_total_tempo[,1], as.data.frame(rollmean(casos_total_tempo[,2:10],
                                                                                       k = 7, fill = NA)))
...
##Tornar gráfico interativo
casos_total_tempo_media_rolante_grafico_linhas_interativo <- ggplotly(casos_total_tempo_media_rolante_grafico_linhas)
...
#Tornar gráfico interativo
prevalencia_idade_grafico_interativo <- ggplotly(prevalencia_idade_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Prevalência (%)",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
prevalencia_tempo_idade_grafico_interativo <- ggplotly(prevalencia_tempo_idade_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Taxa de Incidência Cumulativa (%)",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 1)),
...
#Tornar gráfico interativo
ggplotly(mortes_fem_masc_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Número de Mortes",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
mortos_regioes_grafico <- ggplot(mortos_regioes, aes(x = Regioes, y = Mortes)) +
  ...
  theme_classic() +
  theme(axis.title.y = element_text(size = 12))
mortos_regioes_grafico_interativo <- ggplotly(mortos_regioes_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                       "Número de Mortes",
                                       rep("&nbsp;", 20),
                                       rep("\n&nbsp;", 2)),
...
mortos_regioes_mapa <- leaflet(mapa_pt) %>% 
  ...
  addPolygons(
    ...
    labelOptions = labelOptions(style = list("font-weight" = "normal", 
                                ...
                                textsize = "15px",
                                direction = "auto")) %>% 
  addLegend(pal = pal_3, values = incidencia_regioes_ordem[,2], opacity = 0.7, title = "Número de Mortes",
            position = "bottomright")
...
mortalidade_regioes_grafico_interativo <- ggplotly(mortalidade_regioes_grafico) %>% 
  layout(yaxis = list(title = paste0(c(rep("&nbsp;", 20),
                                     "Taxa de Mortalidade (%)",
                                     rep("&nbsp;", 20),
                                     rep("\n&nbsp;", 2)),
...
mortalidade_regioes_mapa <- leaflet(mapa_pt) %>% 
  ...
  addPolygons(
    ...
    labelOptions = labelOptions(style = list("font-weight" = "normal", 
                                ...
                                textsize = "15px",
                                direction = "auto")) %>% 
  addLegend(pal = pal_4, values = mortalidade_regioes_ordem[,2], opacity = 0.7, title = "Taxa de Mortalidade (%)",
            position = "bottomright")
...
#Tornar gráfico interativo
ggplotly(letalidade_tempo_grafico, add_tracey = "Taxa de Letalidade (%)") %>% 
  layout(legend = list(x = 1, y = 0))
```
...
ggplotly(letalidade_tempo_idade_grafico)
...
letalidade_regioes_mapa <- leaflet(mapa_pt) %>% 
  ...
  addPolygons(
    ...
    labelOptions = labelOptions(style = list("font-weight" = "normal", 
                                ...
                                textsize = "15px",
                                direction = "auto")) %>% 
  addLegend(pal = pal_5, values = letalidade_regioes_ordem[,2], opacity = 0.7, title = "Taxa de Letalidade (%)",
            position = "bottomright")
...
<br>
<ul>
  <li>Taxa de Letalidade Ajustada à Idade</li>
  <li>Taxa de Letalidade Ajustada ao Género</li>
  <li>Taxa de Letalidade Ajustada ao Desfasamento - precisamos de saber o tempo desde o internamento até morte ou usar dados de outro país</li>
  <li>Taxa de Recuperação Ajustada ao Desfasamento - precisamos de saber o tempo desde a confirmação até à recuperação ou usar dados de outro país</li>
  <li>Saber o número de camas em Portugal e por região</li>
</ul>
<br>
